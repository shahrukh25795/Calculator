...
public class calc extends Frame implements ActionListener{
	...
	public calc() { 		//constructor to initialize variables.
		...
		res.setBackground(Color.yellow);	//setting the background color(color behind text)
...
public static void main(String args[]) { 
	calc cal = new calc();  
	cal.setSize(370,350); 
	cal.setTitle("My Calculator");
	cal.setFont(new Font("italic", Font.BOLD, 12));
